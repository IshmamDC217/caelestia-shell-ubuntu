...
> **On Ubuntu 26.04?** Use [ubuntu-26.04.md](ubuntu-26.04.md) instead - 26.04 packages Hyprland and needs a Qt 6.10 compatibility patch this guide does not cover.
...
|------|-------------|-------------|
| `config/25.10/shell.json` | `~/.config/caelestia/shell.json` | Caelestia shell configuration |
| `config/25.10/quickshell/qml_color.json` | `~/.config/quickshell/qml_color.json` | Quickshell color theme |
| `config/25.10/hypr/hyprland.conf` | `~/.config/hypr/hyprland.conf` | Hyprland config (reference only) |
| `config/25.10/bashrc.snippet` | append to `~/.bashrc` | QML_IMPORT_PATH environment variable |
| `install-25.10.sh` | -- | Automated installer script |
...
Copy `config/25.10/shell.json` from this repo to `~/.config/caelestia/shell.json`, or create your own.
...
Copy `config/25.10/quickshell/qml_color.json` from this repo to `~/.config/quickshell/qml_color.json`. This controls the Quickshell color scheme. Caelestia will regenerate this file when you change themes.
